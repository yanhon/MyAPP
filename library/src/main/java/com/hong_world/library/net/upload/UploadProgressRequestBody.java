 ...
 *     MultipartBody.Part body =  MultipartBody.Part.createFormData(key, fileName, new UploadProgressRequestBody(requestBody, UploadProgressCallBack))
 * Version:
 */
public class UploadProgressRequestBody extends RequestBody {

    protected RequestBody delegate;
    protected UploadProgressCallBack progressCallBack;

    protected CountingSink countingSink;

    public UploadProgressRequestBody(UploadProgressCallBack listener) {
        this.progressCallBack = listener;
    }

    public UploadProgressRequestBody(RequestBody delegate, UploadProgressCallBack progressCallBack) {
    ...
    protected final class CountingSink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            ...
            Logger.i("bytesWritten=" + bytesWritten + " ,totalBytesCount=" + contentLength);
        }
    }
