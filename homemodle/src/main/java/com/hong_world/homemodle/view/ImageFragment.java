...
import com.hong_world.common.utils.PermissionManager;
...
public class ImageFragment extends BaseUploadImageFragment<HomePresenter, FragmentHomeBinding> implements HomeContract.View {
...
//                    return true;
                addDisposable(PermissionManager.checkPermission(ImageFragment.this, "存储空间、相机", () -> {
